...
const AddTimeBlockModal: React.FC<AddTimeBlockModalProps> = ({
  open,
  initial = {},
  onSave,
  onClose,
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-sm relative">
        <button
          className="absolute top-2 right-2 text-gray-400 hover:text-red-500 dark:hover:text-red-400 text-2xl font-bold transition-colors"
          aria-label="Close"
          onClick={onClose}
        >
          ×
        </button>
        <h3 className="text-2xl font-extrabold mb-6 text-center text-sky-500 dark:text-sky-300 tracking-tight drop-shadow">
          Add Time Block
        </h3>
        <div className="mb-4">
        ...
        <div className="flex gap-3 mb-4">
          <div className="flex-1">
            ...
            <input
              type="time"
              className="w-full rounded-lg px-3 py-2 border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-400 shadow-sm transition"
              value={startTime}
        ...
        <div className="mb-4 flex gap-3 items-center">
          ...
          <select
            ...
            className="rounded-lg px-2 py-2 border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-400 shadow-sm transition"
          >
            {defaultColors.map((c) => (
          ...
          <label className="block text-xs font-semibold ml-2 text-gray-700 dark:text-gray-200">
            Icon
          </label>
          <select
            value={icon}
        ...
        <button
          className="w-full mt-4 px-3 py-3 rounded-lg bg-gradient-to-r from-sky-400 to-blue-500 hover:from-sky-500 hover:to-blue-600 text-white text-base font-bold shadow-lg transition-all duration-200"
          onClick={handleSave}
        >
          Save
        </button>
